...
import com.example.quickfix.adapter.AllCategoryAdapter;
import com.example.quickfix.model.AllCategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(AllCategory.this, HomeActivity.class);
                startActivity(back);
                finish();
            }
        });
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.cctv));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.house));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.plumber));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.mechanic));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.carpenter));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.electrician));
