package com.example.quickfix.adapter;
...
import com.example.quickfix.ProductDetails;
...
public class RecentlyViewedAdapter extends RecyclerView.Adapter<RecentlyViewedAdapter.RecentlyViewedViewHolder> {
    ...
    public void updateData(List<RecentlyViewed> newList) {
        recentlyViewedList = newList;
